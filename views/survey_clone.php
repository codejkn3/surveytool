    ...
    <div id="site_content">
      <div id="content">
        ...
        <?php if (! empty($survey) && $survey instanceof Survey): ?>
          <form id="survey_edit_form" action="survey_clone.php" method="post">
            ...
            <div class="input_form survey_edit">
              ...
              <div>
                ...
                <?php $newsurvey_name = htmlspecialchars($survey->survey_name) . " (-cloned-)";?>
                <!-- <input type="text" id="survey_name" name="survey_name" value="<?php echo htmlspecialchars($survey->survey_name); ?>" /> -->
                <input type="text" id="survey_name" name="survey_name" value="<?php echo $newsurvey_name; ?>" />
              </div>
